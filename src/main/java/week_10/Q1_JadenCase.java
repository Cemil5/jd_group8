...
public class Q1_JadenCase {
    ...
    public static void main(String[] args) {
        System.out.println(upperCase("How can mirrors be real if our eyes aren't real"));
//        System.out.println(toJadenCase2(""));
//        System.out.println(toJadenCase1(null));
//        System.out.println(toJadenCase2("most trees are blue"));
    }

    public static String upperCase(String text) { // text should be a parameter
        String[] result = text.split(" ");
        String result1 = "";

        for (String str : result) {
            result1 = result1 + str.toUpperCase().charAt(0) + str.substring(1) + " "; // = result1 +

        }

        return result1.trim(); // trim
    }
