package week_21_twoPointer_UI_practice;
...
public class ValidAnagram {
    ...
    public static void main(String[] args) {
        System.out.println(withArray("listen", "silent"));
    }
...
//            }
    ...
    public static boolean withArray(String s, String t) {
        ...
        for (int i = 0; i < s.length(); i++) {   // Time Complexity: O(n)
            char c1 = s.charAt(i);
            char c2 = t.charAt(i);
            chars[c1 - 'a']++;         // increasing count of that char found in s
            chars[c2 - 'a']--;         // decreasing count of that char found in t
        }
