...
public class Q3_FirstUniqueCharacter {
    ...
    public static String solutionWithStream3(String word){
        if (word == null) throw new IllegalArgumentException("Input should not be null");
        return Stream.of(word.split(""))
                .filter(p->word.indexOf(p) == word.lastIndexOf(p))
                .findFirst().orElse(" ");
    }
    ...
    public static char solutionWithStream5(String str) {
        if (str == null) throw new IllegalArgumentException("Input should not be null");
